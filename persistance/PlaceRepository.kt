...
//    }
        //this is for fetching last places from firebase
    fun getPlacesAroundLocationFirebase(
        lat: Double,
        lng: Double,
        radiusInKm: Double,
            ...
            override fun onDataChange(snapshot: DataSnapshot) {
                ...
                for (child in snapshot.children) {
                    ...
                    place?.let {
                        ...
                        Location.distanceBetween(lat, lng, it.lat, it.lng, result)
                        val distanceInKm = result[0] / 1000.0
